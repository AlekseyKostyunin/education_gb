...
// Ввод данных
int ax = GetNumberFromUser("Введите коррдинату Х точки А: ", "Ошибка ввода данных!");
int ay = GetNumberFromUser("Введите коррдинату Y точки А: ", "Ошибка ввода данных!");
int bx = GetNumberFromUser("Введите коррдинату Х точки B: ", "Ошибка ввода данных!");
int by = GetNumberFromUser("Введите коррдинату Y точки B: ", "Ошибка ввода данных!");
